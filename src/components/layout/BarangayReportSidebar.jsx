...
const BarangayReportSidebar = ({ collapsed, onToggleCollapse }) => {
  ...
  return (
    <div className="barangay-report-sidebar">
      <div className="sidebar-header">
        ...
        />
        {!collapsed && <h5 className="sidebar-title">Barangay Reports</h5>}
        {collapsed && <h5 className="sidebar-title-collapsed">BR</h5>}
      </div>
...
export default BarangayReportSidebar