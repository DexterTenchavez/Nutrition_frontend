...
const OverallPotableWaterReport = () => {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(15)
    doc.text(`POTABLE WATER OVERALL REPORT CY:${yearDisplay}`, pageWidth / 2, 42, { align: 'center' })
    ...
    autoTable(doc, {
      startY: 54,
      head: [['#', 'BARANGAY', 'LEVEL 1', 'LEVEL 2', 'LEVEL 3', 'TOTAL']],
      body,
      theme: 'grid',
    ...
    doc.save(`Overall_PotableWater_Report_${yearDisplay}.pdf`)
  }
        ...
        <Card.Header className="text-center bg-white border-0 pt-3">
          <div className="d-flex align-items-center justify-content-center gap-3">
            ...
            <div>
              ...
              <div className="fw-bold fs-5 text-success">POTABLE WATER OVERALL REPORT CY: {yearDisplay}</div>
