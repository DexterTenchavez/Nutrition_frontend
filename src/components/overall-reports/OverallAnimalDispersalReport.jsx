...
const OverallAnimalDispersalReport = () => {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(15)
    doc.text(`ANIMAL DISPERSAL OVERALL REPORT CY:${yearDisplay}`, pageWidth / 2, 42, { align: 'center' })
    ...
    autoTable(doc, {
      startY: 54,
      head: [['#', 'BARANGAY', 'CHK M', 'CHK F', 'PIG M', 'PIG F', 'GOAT M', 'GOAT F', 'COW M', 'COW F']],
      body,
      theme: 'grid',
    ...
    doc.save(`Overall_AnimalDispersal_Report_${yearDisplay}.pdf`)
  }
        ...
        <Card.Header className="text-center bg-white border-0 pt-3">
          <div className="d-flex align-items-center justify-content-center gap-3">
            ...
            <div>
              ...
              <div className="fw-bold fs-5 text-success">ANIMAL DISPERSAL OVERALL REPORT CY: {yearDisplay}</div>
