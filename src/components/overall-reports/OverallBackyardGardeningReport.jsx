...
const OverallBackyardGardeningReport = () => {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(15)
    doc.text(`BACKYARD GARDENING OVERALL REPORT CY:${yearDisplay}`, pageWidth / 2, 42, { align: 'center' })
    ...
    autoTable(doc, {
      startY: 54,
      head: [['#', 'BARANGAY', 'WITH GARDEN', 'WITHOUT GARDEN', 'TOTAL']],
      body,
      theme: 'grid',
    ...
    doc.save(`Overall_BackyardGardening_Report_${yearDisplay}.pdf`)
  }
        ...
        <Card.Header className="text-center bg-white border-0 pt-3">
          <div className="d-flex align-items-center justify-content-center gap-3">
            ...
            <div>
              ...
              <div className="fw-bold fs-5 text-success">BACKYARD GARDENING OVERALL REPORT CY: {yearDisplay}</div>
