...
const OverallAnimalRaisingReport = () => {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(15)
    doc.text(`ANIMAL RAISING OVERALL REPORT CY:${yearDisplay}`, pageWidth / 2, 42, { align: 'center' })
        ...
        <Card.Header className="text-center bg-white border-0 pt-3">
          <div className="d-flex align-items-center justify-content-center gap-3">
            ...
            <div>
              ...
              <div className="fw-bold fs-5 text-success">ANIMAL RAISING OVERALL REPORT CY: {yearDisplay}</div>
